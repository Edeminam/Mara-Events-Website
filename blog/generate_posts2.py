...
def nav_footer(back="../"):
    return f"""
  <div class="webinar-ticker-bar" id="webinarTickerBar"><div class="webinar-ticker-track-wrapper"><div class="webinar-ticker-track"><div class="webinar-ticker-item"><span class="webinar-badge"><i class="fa-solid fa-bolt"></i> Forthcoming Webinar</span><span class="webinar-title">From Anonymous to In-Demand: How emerging planners get their first big break</span><span class="webinar-detail"><i class="fa-regular fa-calendar-days"></i> August 14, 2026</span><span class="webinar-detail"><i class="fa-regular fa-clock"></i> 2:00PM (WAT)</span></div></div></div><a href="https://forms.gle/iaJ2b533p5DS3vdk9" target="_blank" rel="noopener noreferrer" class="webinar-ticker-btn"><span>Register Now</span><i class="fa-solid fa-arrow-right"></i></a></div>
  <nav class="navbar scrolled" id="navbar"><div class="nav-inner"><a href="{back}index.html" class="nav-logo"><img src="{back}images/Mara Events Logo.png" alt="Mara Events Logo" width="140" height="36" style="height:36px;width:140px;"></a><button class="nav-toggle" id="navToggle" aria-label="Toggle menu"><span></span><span></span><span></span></button><ul class="nav-links" id="navLinks"><li><a href="{back}index.html#events">Events</a></li><li><a href="{back}training.html">Training</a></li><li><a href="{back}blog.html" style="color:var(--accent);font-weight:700;">Blog</a></li><li><a href="{back}index.html#book" class="nav-cta">Book Your Event</a></li></ul></div><div class="mobile-menu" id="mobileMenu"><a href="{back}index.html#events">Events</a><a href="{back}training.html">Training</a><a href="{back}blog.html" style="color:var(--accent);font-weight:700;">Blog</a><a href="{back}index.html#book" class="mobile-cta">Book Your Event</a></div></nav>
"""
