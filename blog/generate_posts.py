...
def nav_footer(back="../"):
    return f"""
  <nav class="navbar scrolled" id="navbar"><div class="nav-inner"><a href="{back}index.html" class="nav-logo"><img src="{back}images/Mara Events Logo.png" alt="Mara Events Logo" width="140" height="36" style="height:36px;width:140px;"></a><button class="nav-toggle" id="navToggle" aria-label="Toggle menu"><span></span><span></span><span></span></button><ul class="nav-links" id="navLinks"><li><a href="{back}index.html#events">Events</a></li><li><a href="{back}webinar.html">Webinar</a></li><li><a href="{back}gallery.html">Gallery</a></li><li><a href="{back}training.html">Training</a></li><li><a href="{back}blog.html" style="color:var(--accent);font-weight:700;">Blog</a></li><li><a href="{back}index.html#book" class="nav-cta">Book Your Event</a></li></ul></div><div class="mobile-menu" id="mobileMenu"><a href="{back}index.html#events">Events</a><a href="{back}webinar.html">Webinar</a><a href="{back}gallery.html">Gallery</a><a href="{back}training.html">Training</a><a href="{back}blog.html" style="color:var(--accent);font-weight:700;">Blog</a><a href="{back}index.html#book" class="mobile-cta">Book Your Event</a></div></nav>
"""
